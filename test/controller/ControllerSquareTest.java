...
/**
 * Tests for the {@link IControllerImpl} class.
 */
public class ControllerSquareTest {
  class MockModel implements ReadOnlyReversiModel {
  ...
  class MockView implements IView {
    ...
    private boolean showPlayerTurnMessageCalled = false;
  ...
  private ControllerTest.MockModel mockModel;
  private ControllerTest.MockView mockView;
  private IControllerImpl controller;

  @Before
  public void setUp() {
    mockModel = new ControllerTest.MockModel();
    mockView = new ControllerTest.MockView();
